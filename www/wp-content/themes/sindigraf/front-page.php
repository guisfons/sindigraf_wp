...
<main>
		...
		<div class="associe-cards">
			<div class="associe-cards-box">
				<div class="associe-cards-images">
					<img src="<?php echo get_template_directory_uri(); ?>/assets/images/home/sindigraf-bg.png" alt="" class="associe-bg-image">
					<img src="<?php echo get_template_directory_uri(); ?>/assets/images/home/logo-bg-sindigraf.png" alt="" class="associe-img-logo">
				</div>
			...
			<div class="associe-cards-box">
				<div class="associe-cards-images">
					<img src="<?php echo get_template_directory_uri(); ?>/assets/images/home/abigraf-bg.png" alt="" class="associe-bg-image">
					<img src="<?php echo get_template_directory_uri(); ?>/assets/images/home/logo-bg-abigraf.png" alt="" class="associe-img-logo">
				</div>
				<div class="associe-card-text">
					<a href="#" class="associe-card-parag">Conheça o Guia de Benefícios</a>
				</div>
	...
	<section class="parceiros wrapper">
		...
		<figure class="parceiros-box">
			<img src="<?php echo get_template_directory_uri(); ?>/assets/images/home/parceiros.png" class="parceiros-image">
		</figure>
	</section>
</main>
